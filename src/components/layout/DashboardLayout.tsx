...
const navConfig: Record<Role, NavItem[]> = {
  SUPER_ADMIN: [
    ...
    { label: 'Ujian (Overview)', href: '/dashboard/admin/ujian',      icon: <FileText className="w-5 h-5" /> },
    { label: 'Ujian (Kelola)',   href: '/dashboard/guru/ujian',       icon: <PenTool className="w-5 h-5" /> },
    ...
    { label: 'Nilai & Tugas',    href: '/dashboard/admin/nilai-tugas', icon: <BookOpen className="w-5 h-5" /> },
...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/dashboard/admin/ujian':     'Overview Ujian',
  ...
  '/dashboard/admin/nilai-tugas':   'Monitor Nilai & Tugas',
